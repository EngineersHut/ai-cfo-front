    ...
    <div className="space-y-6 animate-in zoom-in-95 duration-500 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-100 pb-5">
        <div className="space-y-1">
          <h1 className="text-[26px] font-bold text-slate-850 font-inter tracking-tight">
            Export Report
          </h1>
          <div className="flex items-center gap-1.5">
            <span className="text-[13.5px] font-medium text-slate-400 font-inter">
        ...
        <div className="text-left md:text-right mt-3 md:mt-0">
          <span className="text-[16px] font-bold text-[#8c5cf6] font-inter uppercase tracking-wide">
            REPORT #4402-25
          </span>
      ...
      <div className="w-full bg-[#e8f5e9] border border-[#c8e6c9]/50 h-[48px] px-4 rounded-[8px] flex items-center gap-3">
        ...
        <span className="text-[13.5px] font-medium text-[#2e7d32] font-inter">
        ...
        <div className="bg-white rounded-[16px] border border-slate-100 p-5 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden flex flex-col justify-between min-h-[142px]">
          <div className="flex items-center justify-between pb-1">
            <div className="flex items-center gap-2.5 text-[#64748b]">
              ...
              <span className="text-[14px] font-normal font-inter leading-[20px] text-[#64748b]">
                Revenue Forecast
              </span>
            </div>
            <span className="w-[100px] h-[24px] pt-[4px] pr-[8px] pb-[4px] pl-[8px] rounded-[4px] bg-[#f1f5f9] text-[12px] font-normal font-inter leading-[16px] text-[#0f172a] align-middle flex items-center justify-center">
              Next 3 months
            </span>
          </div>
          ...
          <div className="flex items-end justify-between pt-1">
            <div className="space-y-0.5">
              <h2 className="text-[26px] font-bold text-slate-800 font-inter leading-none">
                $128,400
              </h2>
              <span className="text-[11.5px] text-slate-400 font-inter">
                vs last mo.
              </span>
            </div>
        ...
        <div className="bg-white rounded-[16px] border border-slate-100 p-5 shadow-sm flex flex-col justify-between min-h-[420px]">
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-slate-50 pb-4 mb-1">
              ...
              <span className="text-[16px] font-normal font-inter leading-[24px] text-[#0f172a]">
            ...
            <div className="space-y-2">
              <label className="text-[14px] font-medium font-inter leading-[20px] text-black">
                File Format
              </label>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`h-[38px] px-3 rounded-[8px] flex items-center justify-center gap-1.5 text-[12.5px] font-semibold font-inter transition-all ${
                        exportFormat === fmt.id
              ...
              <div className="space-y-2 pt-2">
                {[
                  ...
                  >
                    ...
                    <span className="text-[12px] font-normal font-inter leading-[16px] text-[#0f172a] transition-colors">
                      {sec.label}
                    </span>
                  </label>
                ))}
          ...
          <div className="space-y-3 pt-5 border-t border-slate-50 mt-6">
            ...
            <p className="text-[10.5px] text-slate-400 font-inter text-center leading-relaxed px-2">
              Exporting a secure link will allow stakeholders to view this live
              report for 7 days. Encrypted with AES-256 standards.
            </p>
          </div>
        </div>
      </div>
      <div className="w-full h-auto md:h-[174px] bg-white rounded-[12px] border border-slate-100 shadow-sm overflow-hidden pb-4 md:pb-0">
        ...
        <div className="h-[54px] flex items-center p-[12px] gap-[12px] border-b border-slate-50">
          ...
          <h3 className="text-[16px] font-normal text-slate-800 font-inter leading-[24px] tracking-[0%]">
            AI Insights
          </h3>
        </div>
