                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            ...
                            <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                                <div className="relative group">
                                    <select defaultValue="Monthly" className="appearance-none w-[105px] h-[36px] pt-[4px] pr-[32px] pb-[4px] pl-[12px] bg-white dark:bg-slate-800 border border-[#e2e8f0] dark:border-slate-600 rounded-[8px] text-[14px] font-medium text-[#131b2e] dark:text-slate-300 font-inter leading-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.08)] cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-500/30 transition-all">
