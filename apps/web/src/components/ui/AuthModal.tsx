...
export default function AuthModal({
  ...
  return (
    <Modal
      ...
      width="398px"
      className="!bg-white dark:!bg-white !border-slate-200 dark:!border-slate-200"
    >
      <div
      ...
      >
        ...
        <div className="text-center mb-5">
          <h2 className="text-[#0f172a] font-medium text-[24px] leading-[32px] tracking-normal text-center font-inter">
            Welcome to{" "}
            <span className="text-[#2563eb]">North Quest Solution</span>
          </h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full h-[38px] bg-white border rounded-[8px] pl-11 pr-[10px] py-[8px] text-[14px] focus:outline-none focus:border-blue-500 transition-colors placeholder:text-slate-400 text-slate-900 shadow-sm autofill-light ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="••••••••••••"
                className={`w-full h-[38px] bg-white border rounded-[8px] pl-11 pr-[40px] py-[8px] text-[14px] focus:outline-none focus:border-blue-500 transition-colors placeholder:text-slate-400 text-slate-900 shadow-sm autofill-light ${
          ...
          <div className="text-center pt-2">
            <p className="font-inter font-normal text-[12px] leading-[16px] text-slate-500 text-center">
              ...
              <button
                ...
                className="text-[#2563eb] font-semibold hover:underline transition-all cursor-pointer"
              >
