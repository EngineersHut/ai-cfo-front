...
// ─── Input field ───────────────────────────────────────────────
function InputField({ label, icon: Icon, type = 'text', placeholder, required, value, onChange, rightEl }) {
  return (
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          style={{ background: 'var(--bg-alt)', borderColor: 'var(--border)', color: 'var(--text-primary)' }}
        />
        {rightEl && (
...
function SocialBtn({ label, icon }) {
  return (
    <button type="button"
      ...
      style={{ borderColor: 'var(--border)', background: 'var(--bg-alt)', color: 'var(--text-primary)' }}>
      {icon}
      {label}
    </button>
  )
          ...
          <motion.div
            ...
            <div className="text-center mb-7">
              <h2 className="text-2xl font-extrabold mb-1" style={{ color: 'var(--text-primary)' }}>
                Welcome to <span className="text-gradient">North Quest Solution</span>
              </h2>
