        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            {/* <button onClick={toggleTheme}
              ...
              style={{ color: 'var(--text-secondary)', borderColor: 'var(--border)', background: 'var(--bg-alt)' }}>
            ...
            <motion.div
              ...
              <div className="flex flex-col gap-2">
                <button onClick={() => { openAuth('login'); setMobileOpen(false) }}
                  className="px-4 py-3 text-sm font-medium rounded-xl border" style={{ color: 'var(--text-primary)', borderColor: 'var(--border)' }}>
                  Login
                </button>
