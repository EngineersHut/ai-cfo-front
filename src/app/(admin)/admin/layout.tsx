    ...
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <aside className="w-64 border-r bg-white dark:bg-slate-900 hidden md:block">
        ...
        <nav className="mt-6 px-4 space-y-2">
          ...
          <a href="#" className="block p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">Users</a>
          <a href="#" className="block p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">Reports</a>
          <a href="#" className="block p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">Settings</a>
        </nav>
      </aside>
