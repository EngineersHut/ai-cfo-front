      ...
      >
        ...
        <main className="flex-1 bg-white relative">
          <div 
            ...
            className="absolute inset-0 rounded-tl-[60px] border-t border-l border-slate-200/30 p-8 overflow-auto shadow-[inset_0_2px_4px_rgba(0,0,0,0.01)]"
          >
            {children}
          </div>
        </main>
